...
public class KafkaSecurity {
  ...
  public static final String KEYTAB_LOCATION = "kafka.keytab.location";
  public static final String PRINCIPAL = "kafka.principal";

  private KafkaSecurity() {

  }

  public static void setupKafkaSecurity(String principal, String keytabLocation) {
    ...
    properties.put("keyTab", keytabLocation);
