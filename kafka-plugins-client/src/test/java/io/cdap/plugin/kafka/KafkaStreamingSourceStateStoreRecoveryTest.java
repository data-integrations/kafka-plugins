...
/**
 * Tests for Kafka streaming source with state store with failure recovery
 ...
 */
public class KafkaStreamingSourceStateStoreRecoveryTest extends HydratorTestBase {
