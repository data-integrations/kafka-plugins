...
public class SparkPluginTest extends HydratorTestBase {
  ...
  private static final ArtifactSummary DATASTREAMS_ARTIFACT = new ArtifactSummary("data-streams", "3.2.0");
  ...
  public static void setupTest() throws Exception {
    ...
    addPluginArtifact(NamespaceId.DEFAULT.artifact("spark-plugins", "1.0.0"), parents,
                      KafkaStreamingSource.class, KafkaUtils.class, DefaultDecoder.class, TopicPartition.class,
